...
#
# Generated by Vivado on Sat Jun 02 23:16:52 CEST 2018
...
#    "/home/marc/workspace/vhdl/fbs-lowfreq-nexys4ddr/hdl/mod-demod/main.vhd"
#    "/home/marc/workspace/vhdl/fbs-lowfreq-nexys4ddr/hdl/mod-demod/Demodulation.vhd"
...
#    "/home/marc/workspace/vhdl/fbs-lowfreq-nexys4ddr/sim/total_sim_tb.vhd"
#    "/home/marc/workspace/vhdl/fbs-lowfreq-nexys4ddr/hdl/xilinx_ip/xadc_wiz_0/sample1khz.txt"
#    "/home/marc/workspace/vhdl/fbs-lowfreq-nexys4ddr/sim/total_sim_tb_behav.wcfg"
#
#*****************************************************************************************
...
set files [list \
 ...
 [file normalize "${origin_dir}/../hdl/mod-demod/main.vhd"] \
 [file normalize "${origin_dir}/../hdl/mod-demod/Demodulation.vhd"] \
]
...
set file "$origin_dir/../hdl/mod-demod/main.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../hdl/mod-demod/Demodulation.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL 2008" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "top_send" -objects $obj
...
# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../hdl/xilinx_ip/lia_0/ila_0.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
# Create 'total_sim' fileset (if not found)
if {[string equal [get_filesets -quiet total_sim] ""]} {
  create_fileset -simset total_sim
}

# Set 'total_sim' fileset object
set obj [get_filesets total_sim]
set files [list \
 [file normalize "${origin_dir}/../sim/total_sim_tb.vhd"] \
 [file normalize "${origin_dir}/../hdl/xilinx_ip/xadc_wiz_0/sample1khz.txt"] \
 [file normalize "${origin_dir}/../sim/total_sim_tb_behav.wcfg"] \
]
add_files -norecurse -fileset $obj $files

# Set 'total_sim' fileset file properties for remote files
set file "$origin_dir/../sim/total_sim_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets total_sim] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj


# Set 'total_sim' fileset file properties for local files
# None

# Set 'total_sim' fileset properties
set obj [get_filesets total_sim]
set_property -name "top" -value "total_sim_tb" -objects $obj
set_property -name "xsim.simulate.runtime" -value "100us" -objects $obj
